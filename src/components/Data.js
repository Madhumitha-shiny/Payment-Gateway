...
const Data = ({id}) => {
  return (
    <div className='mb-4'>
      {id==1 ? <Data1 /> :
      id == 2 ? <Data2 />:
      id == 3 ? <Data3 ad1={ad1} ad2={ad2} ad3={ad3} ad4={ad4} ad5={ad5} ad6={ad6} ad7={ad7} ad8={ad8}/>:
      id == 4 ? <Data4 tm1={tm1} tm2={tm2}/>:
      id == 5 ? <Data5 p1={p1} p2={p2} p3={p3} />: 
      <h1>Click on the buttons to view the data</h1>}
    </div>
